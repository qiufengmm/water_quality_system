...
make_table(
    ...
    [
        ['1', '谢坤', '负责人/后端开发', '告警引擎、JWT认证、站点管理API、系统集成', '单元测试、Bug修复、验收文档'],
        ['2', '姜玉琦', '数据工程师', '数据导出增强（Excel）、集成测试', '集成测试、Bug修复'],
        ['3', '苏航', '前端开发', '告警管理页面、登录页面、后台管理页面、前端集成', '前端告警页面优化、管理后台完善'],
        ['4', '赵宏斌', '文档/统筹', 'AI Plan文档、第3周进度报告', '验收文档、演示PPT'],
    ],
    [1.5, 2.5, 3, 5.5, 5]
)
...
make_table(
    ...
    [
        ['T4.1', '单元测试覆盖（ML/告警/管理模块）', '苏航', '新增测试用例', '1.5天'],
        ['T4.2', '系统集成测试与Bug修复', '全员', '集成测试报告', '2天'],
        ['T4.3', '验收文档完善', '赵宏斌', '验收报告', '1天'],
        ['T4.4', '演示PPT制作', '赵宏斌', '答辩PPT', '1天'],
    ],
    [1.5, 5, 2.5, 4, 1.5]
)
...
body('第4周将进入测试验收阶段：苏航负责新增模块的单元测试，全员进行集成测试和Bug修复，赵宏斌完善验收文档和答辩PPT。届时系统将完成课程要求的全部七个功能模块，具备完整的验收交付条件。')
